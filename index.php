...
<head>
	<title>Zoom a Photo Gallery Category Flat Bootstrap Responsive website Template | Home :: w3layouts</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="keywords" content="Zoom Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
...
<body>
					...
					<div class="container">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav nav-center">
								<li>
									<a href="index.html" class="nav-hover active">Beranda</a>
								</li>
							</ul>
						...
						<div class="wrapper">
							<div class="w3ls-banner-text text-center">
								<div class="col-md-7 col-sm-7 col-xs-7 banner-left">
									<h3>Rasakan pengalaman mendaki di</h3>
									<h4>rinjani</h4>
								</div>
								<div class="col-md-5 col-sm-5 col-xs-5 banner-right">

									<p>Kami bisa membantu Anda mendapatkan foto yang bagus.</p>

									<a href="#about" class="ban-btn button8 scroll">Baca Selengkapnya.</a>
								</div>
							</div>
						</div>
				...
				<li class="next-slide">
					...
					<div class="cd-radial-slider-content">
						<div class="wrapper">
							<div class="w3ls-banner-text text-center">
								<div class="col-md-7 col-sm-7  col-xs-7 banner-left">
									<h3>Rasakan sensasi makan di restoran</h3>
									<h4>padang</h4>
								</div>
								<div class="col-md-5 col-sm-5 col-xs-5 banner-right">
									<p>Ingin rekomendasi makan enak?</p>
									<a href="#about" class="ban-btn button8 scroll">Baca Selengkapnya</a>
								</div>
							</div>
						</div>
	...
	<div class="footer-grid">
		<p>© 2018 Taupan. All rights reserved.
		</p>
	</div>
